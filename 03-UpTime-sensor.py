...
receiver = input("Enter a email to get notifications for when the server goes down: ")
password = getpass("Input your 16 character app password: ")
sender = input("Input a name of the email you want to send the emails (can be anything): ")    
